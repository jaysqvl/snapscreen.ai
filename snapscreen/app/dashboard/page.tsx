...
import { ScanDisplay } from "@/components/scan-display"
...
export default function DashboardPage() {
  ...
  return (
    ...
    >
      <AppSidebar onScanSelect={setSelectedScanId} selectedScanId={selectedScanId} />
      <SidebarInset className="flex flex-1 flex-col">
        <main className="flex flex-1 flex-col overflow-auto">
          {!selectedScanId ? (
            ...
            <ScanDisplay scanId={selectedScanId} />
          )}
        </main>
      </SidebarInset>
    </SidebarProvider>
